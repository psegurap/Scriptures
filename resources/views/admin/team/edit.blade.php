...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>{{__('Edit Member')}}</span></li>
@endsection
@section('styles')
                                        ...
                                        <div class="col-lg-11 mx-auto">
                                            <div class="row">
                                                <div class="col-xl-4 col-lg-12 col-md-4">
                                                    <div class="">
                                                        <img v-show="!change_picture" class="img-thumbnail rounded-0" style="width: 100%; box-shadow: 3px 4px 3px black;" :src="homepath + '/images/team/' + member.attach_reference + '/' + member.img_thumbnail" alt="">
...
<script src="{{asset('/js/custom/admin/edit_team.js')}}"></script>
