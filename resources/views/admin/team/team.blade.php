...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>{{__('Team')}}</span></li>
@endsection
@section('styles')
            ...
            <div class="col-lg-12">
                <div class="widget-content searchable-container list">
                        ...
                        <div class="col-xl-8 col-lg-7 col-md-7 col-sm-5 text-sm-right text-center layout-spacing align-self-center pb-0">
                            <div class="d-flex">
                                <div class="switch align-self-center">
                                    <h4 class="font-weight-bold">{{__('Team')}}</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search layout-spacing align-self-center pb-0">
                            <div class="my-2 my-lg-0">
                                <div class="d-flex align-items-center">
                                    <a :href="homepath + '/admin/team/new'">
                                    ...
                                    <input type="text" class="form-control product-search" id="input-search" placeholder="{{__('Search Member...')}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="searchable-items list">
                        <div v-for="member in members" class="items">
                            <div class="item-content">
                                <div class="user-profile">
                                    <img :src="homepath + '/images/team/' + member.attach_reference + '/' + member.img_thumbnail" alt="avatar">
                                    <div class="user-meta-info">
                                        <p class="user-name" :data-name="member.name">@{{member.name}}</p>
                                        <p class="user-work" :data-email="member.email">@{{member.email}}</p>
                                    </div>
                                </div>
                                <div class="action-btn">
                                    <a :href="homepath + '/admin/team/edit/' + member.id">
...
@section('scripts')
    ...
    <script src="{{asset('/js/custom/admin/team.js')}}"></script>
