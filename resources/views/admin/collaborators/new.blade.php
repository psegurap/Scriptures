                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea v-validate="'required|max:300'" class="form-control" name="biography (es)" id="aboutBio" style="height: 100%;" v-model="collaborator.biography_es" placeholder="Tell something interesting about yourself" rows="5"></textarea>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea v-validate="'required|max:300'" class="form-control" name="biography (en)" id="aboutBio" style="height: 100%;" v-model="collaborator.biography_en" placeholder="Tell something interesting about yourself" rows="5"></textarea>
