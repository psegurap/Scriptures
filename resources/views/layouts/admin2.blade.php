...
<head>
    ...
    <title>@yield('title') ─ Escrituras | {{__('Configuration')}}</title>
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="dropdown" data-parent="#accordionExample">
                            <li class="">
                                <a href="#"> Option #1 </a>
                            </li>
                            <li>
        ...
        <div id="content" class="main-content">
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © 2020 <a target="_blank" href="www.seguratesting.com">Pedro Segura</a>, All rights reserved.</p>
                </div>
