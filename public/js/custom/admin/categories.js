                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: function(data, row){
                                return "<div class='d-flex justify-content-around'><div class='text-info badge' ><i onclick='main.editCategory("+data+")' style='cursor:pointer' class='fa fa-pencil-square-o fa-lg fa-2x'></i></div><div class='text-danger badge' ><i onclick='main.deleteCategory("+data+")' style='cursor:pointer' class='fa fa-trash fa-lg fa-2x'></i></div></div>"
                            }
                        }
                    ]
                });
